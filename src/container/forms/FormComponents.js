...
import { Row, Col, Form, Input, Card, Switch, DatePicker, Upload, message } from 'antd';
    ...
    <>
      ...
      <Main>
        <FormComponentsWrap>
          <Row gutter={25}>
            <Col lg={12}>
              <Card title="Input Groups" className="mb-25">
                <BasicFormWrapper>
              ...
              <Card title="Dropdowns" className="mb-25">
              ...
              <Card title="Datepicker" className="mb-25">
              ...
              <Card title="Text Editor" className="mb-25">
            ...
            <Col lg={12}>
              <Card title="Tags" className="mb-25">
              ...
              <Card title="Toggle buttons" className="mb-25">
                <Switch defaultChecked size="large" />
              </Card>
              <Card title="Sliders" className="mb-25">
              ...
              <Card title="Dropzone" className="mb-25">
