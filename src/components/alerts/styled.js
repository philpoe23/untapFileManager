...
const AlertStyled = Styled(Alert)`    
  background: ${({ type, theme }) => theme[type + '-color']} !important;
  border: 1px solid ${({ type, theme }) => theme[type + '-color']} !important;
  ...
  &:hover, &:focus, &:active {
      ...
      border: 1px solid ${({ type, theme }) => theme[type + '-color']}90 !important;              
  }
`;
