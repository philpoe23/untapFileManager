...
const Cards = props => {
  const { title, more, moreText, size, headless, caption, isbutton, bodyStyle, headStyle, border, padding } = props;
  return (
    <Fragment>
      {!headless ? (
        <CardFrame
        ...
        <CardFrame padding={padding} bodyStyle={bodyStyle && bodyStyle} size={size} style={{ width: '100%' }} bordered={border}>
