...
const ButtonStyled = Styled(Button)`
    background: ${({ type }) => type !== 'default' && theme[type + '-color']};
    border: 1px solid ${({ type }) => (type !== 'default' ? theme[type + '-color'] : theme['disabled-color'])};
    ...
    &:hover, &:focus {
        background: ${({ type }) => type !== 'default' && theme[type + '-color']}90;
        border: 1px solid ${({ type }) => type !== 'default' && theme[type + '-color']}90;
        color: ${({ type }) => type !== 'default' && '#ffffff'};        
    }
`;
...
const ButtonStyledOutline = Styled(Button)`
    ...
    border: 1px solid ${({ type }) => (type !== 'default' ? theme[type + '-color'] : theme['disabled-color'])};
    color: ${({ type }) => type !== 'default' && theme[type + '-color']};
    margin: 4px;
    border-radius: ${({ shape }) => (!shape ? '4px' : '40px')};
    padding: 0px 15px;
    ...
    &:hover, &:focus {
        background: ${({ type }) => type !== 'default' && theme[type + '-color']};
        border: 1px solid ${({ type }) => type !== 'default' && theme[type + '-color']};
        color: ${({ type }) => type !== 'default' && '#ffffff'};        
    }
`;
